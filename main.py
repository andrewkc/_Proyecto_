...
from funciones_1 import hangdraw # Importamos la función 'ahorcado' del módulo 'funciones_1.py'.
...
def ahorcar(a):
    ...
    **** El Ahorcado *** dependiendo el valor de a.
    ...
    # letras que el usuario va a divinar.
    opciones = [] 
    ...
    if a == 1:
        ...
        # Se sobreescribe 'opciones' por la siguiente lista con nombres de series.
        opciones = ["BREAKING BAD","SQUID GAME","GAME OF THRONES","PRISON BREAK","LUCIFER","DARK","YOU","WHAT IF",
                    ...
                    "THE SIMPSONS","STRANGER THINGS","GREYS ANATOMY"] 
        ...
        # Se sobreescribe 'opciones' por la siguiente lista con nombres de películas.
        ...
        # Se sobreescribe 'opciones' por la siguiente lista con nombres de cursos de CS.
